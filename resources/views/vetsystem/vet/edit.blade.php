            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form">
                            <form class="form-validate form-horizontal " role="form" method="POST" action="{{ route('vet.update',$vet->id) }}" novalidate="novalidate">
                                @csrf
                                {{method_field('PUT')}}
                                <div class="form-group ">
                                    <label for="nombre" class="control-label col-lg-2">Nombre <span class="required">*</span></label>
                                    <div class="col-lg-4">
                                        <input class=" form-control" id="nombre" name="nombre" type="text" value='{{$vet->user->name}}'>
                                    ...
                                    <div class="col-lg-4">
                                        <input class=" form-control" id="apellido" name="apellido" type="text" value='{{$vet->user->last_name}}'>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-4">
                                        <input class=" form-control" id="email" name="email" type="email" value='{{$vet->user->email}}'>
                                        @if ($errors->has('email'))
                                            <label for="email" class="control-label text-left text-danger">{{$errors->first('email')}}</label>
                                        @endif
                                    </div>
                                    <label for="contraseña" class="control-label col-lg-2">Nueva Contraseña <span class="required">*</span></label>
                                    <div class="col-lg-4">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-4">
                                        <input class=" form-control" id="telefono" name="telefono" type="text" value='{{$vet->phone->mobile_phone}}'>
                                    ...
                                    <div class="col-lg-4">
                                        <input class=" form-control" id="rut" name="rut" type="text" value='{{$vet->rut}}'>
                                        @if ($errors->has('rut'))
                                    ...
                                    <div class="col-lg-10">
                                        <select class="form-control" name="especialidades[]" id="especialidades[]" multiple="multiple">
                                            @foreach ($specialties as $specialty)
                                                <option value="{{$specialty->id}}" @foreach ($vet->specialties as $spec)
                                                    @if ($spec->id == $specialty->id) selected @endif
                                                @endforeach >{{$specialty->name}}</option>
                                            @endforeach
