    ...
    <section class="wrapper">
        ...
        <div class="row">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-paw"></i>Tipos de Examenes</li>
            </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <a href="{{route('exam.create')}}" class="btn btn-info btn-block">Agregar Tipo Examen</a>
            </div>
        </div>
        <br>
        <div class="row">
                            ...
                            <table class="table table-striped table-hover" id="example1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style=""><i class="fa fa-paw"></i> Carasteristicas</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$exam->name}}</td>
                                        <td>{{str_limit($exam->characteristics, 40)}}</td>
                                        <td>{{$exam->views}}</td>
                                        <td>{{$exam->type}}</td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="{{route('exam.edit', $exam->id)}}" class="btn btn-sm btn-success"><i class="fas fa-pen"></i></a>
                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#eliminar_process-{{$exam->id}}"><i class="fas fa-trash"></i>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <div class="modal modal-danger fade" id="eliminar_process-{{$exam->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
